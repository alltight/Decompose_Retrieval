...
text_retrieval_datasets = ["trec-covid", "nq", "climate-fever", "hotpotqa", "msmarco", "webis-touche2020", "scifact", "fiqa", "strategyqa", "webq"]
...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default="./yzl_test/", help='config file')
    parser.add_argument('--dataset_name', type=str, default="webq", help='config file')
...
if __name__ == "__main__":       
    ...
    # elif args.dataset_name == "strategyqa":
    elif args.dataset_name in ['strategyqa', 'webq']:
        ...
        with open(f"data/{args.dataset_name}/corpus.pkl", "rb") as file:  
            corpus = pickle.load(file)
            
        with open(f"data/{args.dataset_name}/queries.pkl", "rb") as file:  
            queries = pickle.load(file)
